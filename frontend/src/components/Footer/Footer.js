...
<footer aria-label="Site Footer" className="bg-white">
  <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-2 sm:px-6 lg:px-8">
    <div className="lg:flex lg:items-center lg:justify-between">
      <div className="flex justify-center text-teal-600 sm:justify-start text-2xl font-bold">
        NewsHub
      </div>

      <p
        className="mx-auto mt-4 max-w-md text-center leading-relaxed text-gray-500 sm:ml-0 sm:text-left lg:mr-0 lg:mt-0"
      >
    ...
    <div
      className="mt-2 grid grid-cols-1 gap-8 border-t border-gray-100 pt-10 md:grid-cols-4 lg:grid-cols-6"
    >
    ...
    <div
      className="border-t border-gray-100 mt-10 sm:flex sm:items-center sm:justify-between"
    >
